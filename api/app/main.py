...
async def upload_document(case_id: str, file: UploadFile = File(...)):
    ...
    return {"status": "stored", "blob": target_name, "document_name": document_name, "outcome": "accepted", "notification": "Document stored successfully and case flow continues."}
